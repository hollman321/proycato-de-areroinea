...
if (!JWT_ACCESS_SECRET || !JWT_REFRESH_SECRET) {
    console.error('[CRITICAL] JWT Secrets are not fully defined in environment variables');
    process.exit(1);
}
...
exports.verifyToken = (token, isRefresh = false) => {
    ...
    try {
        return jwt.verify(token, isRefresh ? JWT_REFRESH_SECRET : JWT_ACCESS_SECRET, {
            algorithms: ['HS256'],
